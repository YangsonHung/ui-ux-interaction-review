...
- Purely visual styling or brand-design requests with no interaction or state-logic question
- UI implementation code review
- Usability conclusions that require user-research evidence not provided in the task
...
- Distinguish observed facts from inferred behavior, and list missing business rules instead of inventing them.
