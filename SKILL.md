...
description: 审查和重构 UI/UX 交互组件与状态逻辑的专家技能。使用人机交互系统思维、第一性原理和状态机理论，诊断界面中的控制权模糊、状态冲突、信息反馈缺失和认知负荷问题，并输出多维度优化方案。当用户提供 UI 截图、原型图、组件交互描述，或提到"交互逻辑"、"状态设计"、"开关/Tab/联动"、"体验优化"、"设计走查"、"UI 审查"等场景时，应主动使用本技能，即使用户没有明确说"帮我审查"。
---
